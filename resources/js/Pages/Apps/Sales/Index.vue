                            ...
                            <div class="card-body">
                                ...
                                <div v-if="sales">
                                    ...
                                    <div class="export text-end mb-3">
                                        ...
                                        <a :href="`/apps/sales/pdf?start_date=${start_date}&end_date=${end_date}`" target="_blank" class="btn btn-success btn-md border-0 shadow"><i class="fa fa-file-pdf"></i> PDF</a>
                                    </div>
