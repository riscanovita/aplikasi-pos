                            ...
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="mb-3">
                                                ...
                                                <button class="btn btn-md btn-orange border-0 shadow w-100"><i class="fa fa-filter"></i> FILTER</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                ...
                                <div v-if="profits">
                                    ...
                                    <div class="export text-end mb-3">
                                        ...
                                        <a :href="`/apps/profits/pdf?start_date=${start_date}&end_date=${end_date}`" target="_blank" class="btn btn-success btn-md border-0 shadow"><i class="fa fa-file-pdf"></i> PDF</a>
                                    </div>
